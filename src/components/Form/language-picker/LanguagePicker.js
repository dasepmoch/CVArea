...
import IndonesiaFlag from '../../../assets/countries/indonesia.png'
        ...
        return (
            <div className="languagePickerWrapper">
                ...
                <div className="languagePicker">
                    <img src={this.props.values.language === "en" ? UsFlag : this.props.values.language === "es" ? SpainkFlag : this.props.values.language === "fr" ? FranceFlag : this.props.values.language === "ru" ? RussianFlag : this.props.values.language === "id" ? IndonesiaFlag : this.props.values.language === "se" ? SwedenFlag : this.props.values.language == "de"  ? GermanyFlag : this.props.values.language == "pt"  ? PortugalFlag :"" } alt="us" />
                    <span onClick={this.handleClick} className="language">{this.props.values.language === "en" ? "English" : this.props.values.language === "es" ? "Spanish" : this.props.values.language === "fr" ? "French" : this.props.values.language === "ru" ? "Russian" : this.props.values.language === "id" ? "Indonesia" : this.props.values.language === "se" ? "Swedish" : this.props.values.language === "de" ? "German" : this.props.values.language == "pt"  ? "Portuguese" :"" }</span>
                </div>
                {/* Language Dropdown */}
                <div className={this.state.isOpen === "true" ? 'languageDropdown' : 'languageDropDown hidden'}>
                    <ul>
                        {/* Language item */}
                        <li onClick={()=>{this.props.handleLanguageClick("id"); this.closePicker()}} className="languagePicker" >
                            <img src={IndonesiaFlag} alt="Indonesia" />
                            <span className="language" >Indonsia</span>
                        </li>
                        {/*/!* Language item *!/*/}
